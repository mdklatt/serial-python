...
class LongFieldTest(object):
    ...
    @pytest.mark.parametrize(("token", "value"), [
        (" ", -999),
        ("99999999999999999999", 99999999999999999999L)])
    def test_decode(self, token, value):
        """ Test the decode method.
    ...
    @pytest.mark.parametrize(("pos", "fmt", "token", "value"), [
        (0, "d", "-999", None),
        (0, "21d", " 99999999999999999999", 99999999999999999999L),
        ((0, 21), "d", "                 -999", None),
        ((0, 21), "d", " 99999999999999999999", 99999999999999999999L),
        ((0, 21), "22d", "  9999999999999999999", 99999999999999999999L)])
